...
function readJson(apiResponse) {
  ...
  const cloudy = document.getElementById("humidity");  const sunriseTime = document.getElementById("sunrise");
  ...
  const cloud = apiResponse.main.humidity;  const sunrise = apiResponse.sys.sunrise;
